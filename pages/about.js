  ...
  return (
    <div>
      ...
      <div className="my-8">
        ...
        <p>
        Jova’s mission is to make government information accessible and approachable by providing up to date information on congress. Jova aims to equip people with the necessary facts and information to help them become more informed voters. 
        </p>
      </div>
